...
async def list_leads_from_pipedrive(
    ...
    Format requirements:
        - limit_str: Maximum number of leads to return (integer as string, default: 100)
    ...
    logger.debug(
        ...
        f"limit_str='{limit_str}', start='{start}', archived_status='{archived_status}', "
    ...
    limit = None if limit_str == "" else limit_str
